...
import { addGuitar } from "../../store/guitars/actions";
import { connect } from "react-redux";
import GuitarsType from "../../store/guitars/type";

class NewGuitarForm extends React.Component {
  state = {
    make: "",
    model: "",
    year: "",
            ...
            <FormGroup style={{ margin: "15px" }}>
              ...
              <Form.Group controlId="pickupsId">
                ...
                <Form.Control
                  type="text"
                  name="pickups"
                  value={this.state.pickups.value}
                  onChange={this.handleChange}
                  placeholder="Guitar Pickups"
                />
                <Form.Text className="text-muted"></Form.Text>
              </Form.Group>
              ...
              <Form.Group controlId="conditionId">
                ...
                <Form.Control
                  ...
                  onChange={this.handleChange}
                  placeholder="Guitar Condition out of 10"
                />
                <Form.Text className="text-muted"></Form.Text>
              </Form.Group>
              <Form.Group controlId="locationId">
                ...
                <Form.Control
                  type="text"
                  name="location_id"
                  value={this.state.location_id.value}
                  onChange={this.handleChange}
                  placeholder="Guitar Location"
                />
                <Form.Text className="text-muted"></Form.Text>
              </Form.Group>
...
export default connect(mapStateToProps, { addGuitar })(NewGuitarForm);
